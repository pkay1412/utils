					...
					//implements UtilsQualityAssuranceRest
{
	...
	private UtilsQaFacade<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> fQa;
		
	private final Class<GROUP> cGroup;
	private final Class<QA> cQa;
	
	private XmlStaffFactory<L,D,C,R,V,U,A,USER,STAFF,QA> xfStaff;
	private XmlGroupFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> xfGroup;
	private XmlCategoryFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> xfCategory;
	private XmlCategoryFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> xfFrDuration;
	
	private QaRestService(UtilsQaFacade<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> fQa, final Class<L> cL, final Class<D> cD,final Class<GROUP> cGroup,final Class<QA> cQa,final Class<QAC> cQAC,final Class<QAT> cQAT)
	{
		this.fQa=fQa;
		this.cGroup=cGroup;
		this.cQa=cQa;
		...
		xfGroup = new XmlGroupFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(QaQuery.group());
		xfCategory = new XmlCategoryFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(QaQuery.category());
		xfFrDuration = new XmlCategoryFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(QaQuery.frDuration());
	...
	public static <L extends UtilsLang,
					...
					QARS extends UtilsStatus<QARS,L,D>,
					QAUS extends UtilsStatus<QAUS,L,D>>
		QaRestService<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>
			factory(UtilsQaFacade<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> fQa,final Class<L> cL,final Class<D> cD,final Class<GROUP> cGroup,final Class<QA> cQa,final Class<QAC> cQAC,final Class<QAT> cQAT)
	{
		return new QaRestService<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(fQa,cL,cD,cGroup,cQa,cQAC,cQAT);
	}
