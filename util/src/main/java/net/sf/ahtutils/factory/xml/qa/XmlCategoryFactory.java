...
QAUS extends UtilsStatus<QAUS,L,D>>
{
	...
	public void lazyLoader(UtilsQaFacade<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> fQa,Class<QAC> cQAC, Class<QAT> cQAT)
	{
		this.fQa=fQa;
		this.cQAC=cQAC;
		this.cQAT=cQAT;
	...
	public Category build(QAC category)
	{
		...
		if(q.isSetTest())
		{
			XmlTestFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> f = new XmlTestFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(q.getTest().get(0));
