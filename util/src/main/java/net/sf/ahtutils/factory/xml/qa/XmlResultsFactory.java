...
QAUS extends UtilsStatus<QAUS,L,D>>
{
	...
	public Results build(QAT test)
	{
		...
		if(q.isSetResult())
		{
			XmlResultFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS> f = new XmlResultFactory<L,D,C,R,V,U,A,USER,STAFF,GROUP,QA,QASS,QAC,QAT,QAU,QAR,QASH,QATD,QATI,QATC,QATS,QARS,QAUS>(q.getResult().get(0));
